...
SearchMasjidData searchMasjidDataFromJson(String str) =>
    SearchMasjidData.fromJson(json.decode(str));

String searchMasjidDataToJson(SearchMasjidData data) =>
...
class SearchMasjidData {
  ...
  factory SearchMasjidData.fromJson(Map<String, dynamic> json) =>
      SearchMasjidData(
